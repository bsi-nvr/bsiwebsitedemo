...
// Extended jokes collection (Dutch and English)
const catJokes = {
  nl: [
    ...
    '404: Pagina niet gevonden. Luca zit waarschijnlijk ergens op een warm toetsenbord te chillen.',
    ...
    '404: Terug voor meer? Deze pagina is nog steeds leeg. Net als Luca\'s voerbak om 04:00 \'s ochtends.',
    '404: Serieus, alweer? Zelfs Luca de huiskat kijkt je nu veroordelend aan.',
    '404: Luca de huiskat is op onderzoek uit gegaan... Maar zelfs hij snapt niet waarom je hier steeds komt.',
    ...
    '"Ik ben een kat. Ik snap dat je koppig bent. Respect." Maar zelfs ik weet wanneer ik moet stoppen met op de printer springen.',
    'Je hebt Luca\'s aandacht. Dat gebeurt niet snel. Hij kijkt nu met één oog open naar je. Niet vanwege de pagina, maar uit respect.',
    ...
    'Luca is transcendent gegaan. Hij zweeft boven ruimte en tijd. Jij daarentegen... zit nog steeds op de 404. Respect.',
    ...
    'Luca kijkt nu theatraal uit het raam. "Misschien keert de pagina terug met de regen," fluistert hij dramatisch. Jij kijkt mee. Samen wachten jullie.',
    ...
    'Luca mediteert. Over vergankelijkheid. Over lege webpagina\'s. Over mensen die blijven klikken. Over jou.',
    ...
    'Luca kijkt je nu echt recht aan. Zonder knipperen. Jullie delen een moment. Een klik. Geen web-klik. Een ziels-klik.',
    ...
    'Luca is een mythe geworden. De legende van de kat die de 404 bewaakte. En van de bezoeker die nooit opgaf.',
    ...
    'CONGRATULATIES! Je hebt het 404-einde bereikt. Er is geen prijs. Geen geheim. Geen pagina. Alleen Luca. En jij. Voor altijd.',
  ],
  en: [
    ...
    '404: Page not found. Luca is probably chilling on a warm keyboard somewhere.',
    ...
    '404: Back for more? This page is still empty. Just like Luca\'s food bowl at 4:00 AM.',
    '404: Seriously, again? Even Luca the house cat is looking at you judgmentally now.',
    '404: Luca the house cat went investigating... But even he doesn\'t understand why you keep coming here.',
    ...
    '"I\'m a cat. I understand you\'re stubborn. Respect." But even I know when to stop jumping on the printer.',
    'You have Luca\'s attention. That doesn\'t happen often. He\'s now looking at you with one eye open. Not because of the page, but out of respect.',
    ...
    'Luca has gone transcendent. He floats above space and time. You, on the other hand... are still on the 404. Respect.',
    ...
    'Luca is now theatrically looking out the window. "Maybe the page returns with the rain," he whispers dramatically. You look along. Together you wait.',
    ...
    'Luca meditates. About transience. About empty web pages. About people who keep clicking. About you.',
    ...
    'Luca is now really looking you straight in the eye. Without blinking. You share a moment. A click. Not a web click. A soul click.',
    ...
    'Luca has become a myth. The legend of the cat who guarded the 404. And of the visitor who never gave up.',
    'Luca has dug an interdimensional tunnel. On the other side? ...Also no page. But an endless supply of cat treats.',
    'CONGRATULATIONS! You\'ve reached the 404 ending. There\'s no prize. No secret. No page. Only Luca. And you. Forever.',
  ]
}
