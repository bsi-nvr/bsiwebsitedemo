  ...
  if (variant === "grid") {
    return (
      <Link
        ...
        className={cn(
          "group border-b border-r border-border p-8 md:p-12 hover:bg-secondary/10 transition-all duration-500 animate-on-scroll cursor-pointer flex flex-col",
      ...
      >
        ...
        <h3 className="text-2xl md:text-3xl font-serif font-light mb-6 text-balance">
          {title}
        </h3>
        {features && (
        ...
        <span className="inline-flex items-center gap-3 px-6 py-3 border border-foreground/20 group-hover:border-foreground/50 text-sm font-medium text-foreground transition-all duration-300 w-fit mt-auto">
